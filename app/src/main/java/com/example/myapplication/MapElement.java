 ...
 * ImageView and a com.example.myapplication.MapElement, you can do this:
 *
 * ImageView iv = ...;
 * com.example.myapplication.MapElement me = ...;
 ...
 * com.example.myapplication.MapElement has either zero or one com.example.myapplication.Structure} objects. For each grid square, we can also change
